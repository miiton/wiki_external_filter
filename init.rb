  ...
  config.keys.each do |name|
    ...
    Redmine::WikiFormatting::Macros.register do
      ...
      macro name do |obj, args, text|
        m = WikiExternalFilterHelper::Macro.new(self, args, obj.respond_to?('page') ? obj.page.attachments : nil, name, info, text)
        m.render
      end
      ...
      macro (name + "_include").to_sym do |obj, args, text|
        ...
        m = WikiExternalFilterHelper::Macro.new(self, page.content.text, page.attachments, name, info, text)
